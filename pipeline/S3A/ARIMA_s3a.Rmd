...
df <- read.csv("../data_arima/s3a_mean_motion_data.csv", stringsAsFactors = FALSE) # already done interploate
...
write.csv(
  df_fitted,
  file        = "../data_arima/s3a_arima_predictions_with_dates.csv",
  row.names   = FALSE,
  fileEncoding = "UTF-8"
)
```
